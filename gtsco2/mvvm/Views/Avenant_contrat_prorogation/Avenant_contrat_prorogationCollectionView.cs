...
namespace gtsco2.mvvm.Views.Avenant_contrat_prorogationCollectionView{
    public partial class Avenant_contrat_prorogationCollectionView : XtraForm
    {
        public Avenant_contrat_prorogationCollectionView() {
            InitializeComponent();
			 if(!mvvmContext.IsDesignMode)
                InitBindings();
        }
        void InitBindings() {
            var fluentAPI = mvvmContext.OfType<gtsco2.mvvm.ViewModels.Avenant_contrat_prorogationCollectionViewModel>();
