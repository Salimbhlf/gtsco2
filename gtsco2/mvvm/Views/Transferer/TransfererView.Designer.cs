namespace gtsco2.mvvm.Views.TransfererView {
    partial class TransfererView {
		...
		private void InitializeComponent() {
			...
			this.dataLayoutControl1.DataSource = transfererViewBindingSource;
			//
			//Create GridControls
			//
			...
			this.EtablissementLookUpEdit.DataBindings.Add("EditValue", transfererViewBindingSource, "ID_etb", true, System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged);
			DevExpress.XtraDataLayout.RetrieveFieldParameters EtablissementLookUpEditRetrieveFieldParameters = new DevExpress.XtraDataLayout.RetrieveFieldParameters();
            EtablissementLookUpEditRetrieveFieldParameters.FieldName = "ID_etb";
            EtablissementLookUpEditRetrieveFieldParameters.ControlForField = this.EtablissementLookUpEdit;
			parameters.CustomListParameters.Add(EtablissementLookUpEditRetrieveFieldParameters);
			DevExpress.XtraDataLayout.RetrieveFieldParameters EtablissementLookUpEditRetrieveFieldParameters_NotGenerate = new DevExpress.XtraDataLayout.RetrieveFieldParameters();
		    EtablissementLookUpEditRetrieveFieldParameters_NotGenerate.FieldName = "Etablissement";
		    EtablissementLookUpEditRetrieveFieldParameters_NotGenerate.GenerateField = false;
			parameters.CustomListParameters.Add(EtablissementLookUpEditRetrieveFieldParameters_NotGenerate);
						//
			//StagiairLookUpEdit
			//
			...
			this.StagiairLookUpEdit.DataBindings.Add("EditValue", transfererViewBindingSource, "num_stg", true, System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged);
            ...
            this.mvvmContext.ViewModelType = typeof(gtsco2.mvvm.ViewModels.TransfererViewModel);
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(gtsco2.mvvm.ViewModels.TransfererViewModel), "Save", bbiSave));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(gtsco2.mvvm.ViewModels.TransfererViewModel), "SaveAndClose", bbiSaveAndClose));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(gtsco2.mvvm.ViewModels.TransfererViewModel), "SaveAndNew", bbiSaveAndNew));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(gtsco2.mvvm.ViewModels.TransfererViewModel), "Reset", bbiReset));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(gtsco2.mvvm.ViewModels.TransfererViewModel), "Delete", bbiDelete));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(gtsco2.mvvm.ViewModels.TransfererViewModel), "Close", bbiClose));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(gtsco2.mvvm.ViewModels.TransfererViewModel), "SaveLayout", bbiSaveLayout));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(gtsco2.mvvm.ViewModels.TransfererViewModel), "ResetLayout", bbiResetLayout));
