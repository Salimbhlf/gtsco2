namespace gtsco2.mvvm.Views.TransfererCollectionView {
    partial class TransfererCollectionView {
		...
		private void InitializeComponent() {
			...
			this.gridControl.DataSource = transfererCollectionViewBindingSource;
			...
			//Etablissement
			//
			DevExpress.XtraGrid.Extensions.PopulateColumnParameters EtablissementPopulateColumnParameters = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            EtablissementPopulateColumnParameters.FieldName = "Etablissement";
            EtablissementPopulateColumnParameters.Path = "Etablissement.Nom_ETAB";
			parameters.CustomColumnParameters.Add(EtablissementPopulateColumnParameters);
						DevExpress.XtraGrid.Extensions.PopulateColumnParameters EtablissementPopulateColumnParameters_NotGenerate = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            EtablissementPopulateColumnParameters_NotGenerate.FieldName = "ID_etb";
		    EtablissementPopulateColumnParameters_NotGenerate.ColumnVisible = false;
			parameters.CustomColumnParameters.Add(EtablissementPopulateColumnParameters_NotGenerate);
									//
			//Stagiair
			//
			...
			DevExpress.XtraGrid.Extensions.PopulateColumnParameters EtablissementPopulateColumnParameters_NotVisible = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            EtablissementPopulateColumnParameters_NotVisible.FieldName = "Etablissement";
		    EtablissementPopulateColumnParameters_NotVisible.ColumnVisible = false;
			parameters.CustomColumnParameters.Add(EtablissementPopulateColumnParameters_NotVisible);
			...
			parameters.CustomColumnParameters.Add(StagiairPopulateColumnParameters_NotVisible);
						this.gridView.PopulateColumns(typeof(gtsco2.basededonne.Transferer),parameters);
			// 
            // popupMenu1
            // 
            ...
            this.mvvmContext.ViewModelType = typeof(gtsco2.mvvm.ViewModels.TransfererCollectionViewModel);
								this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(gtsco2.mvvm.ViewModels.TransfererCollectionViewModel), "New", bbiNew));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(gtsco2.mvvm.ViewModels.TransfererCollectionViewModel), "Edit", "SelectedEntity", bbiEdit));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(gtsco2.mvvm.ViewModels.TransfererCollectionViewModel), "Delete", "SelectedEntity", bbiDelete));
					this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(gtsco2.mvvm.ViewModels.TransfererCollectionViewModel), "Refresh", bbiRefresh));
