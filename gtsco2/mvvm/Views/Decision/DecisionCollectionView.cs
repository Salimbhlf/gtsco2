...
namespace gtsco2.mvvm.Views.DecisionCollectionView{
    public partial class DecisionCollectionView : XtraForm
    {
        public DecisionCollectionView() {
            InitializeComponent();
			 if(!mvvmContext.IsDesignMode)
                InitBindings();
        }
        void InitBindings() {
            var fluentAPI = mvvmContext.OfType<gtsco2.mvvm.ViewModels.DecisionCollectionViewModel>();
