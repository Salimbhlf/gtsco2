...
namespace gtsco2.mvvm.Views.Proce_verbal_delibationCollectionView{
    public partial class Proce_verbal_delibationCollectionView : XtraForm
    {
        public Proce_verbal_delibationCollectionView() {
            InitializeComponent();
			 if(!mvvmContext.IsDesignMode)
                InitBindings();
        }
        void InitBindings() {
            var fluentAPI = mvvmContext.OfType<gtsco2.mvvm.ViewModels.Proce_verbal_delibationCollectionViewModel>();
            ...
            fluentAPI.WithEvent<GridView, FocusedRowObjectChangedEventArgs>(gridView, "FocusedRowObjectChanged")
                .SetBinding(x => x.SelectedEntity,
                    args => args.Row as gtsco2.basededonne.Proce_verbal_delibation,
