...
namespace gtsco2.mvvm.Views.EtablissementCollectionView{
    public partial class EtablissementCollectionView : XtraForm
    {
        public EtablissementCollectionView() {
            InitializeComponent();
			 if(!mvvmContext.IsDesignMode)
                InitBindings();
        }
        void InitBindings() {
            var fluentAPI = mvvmContext.OfType<gtsco2.mvvm.ViewModels.EtablissementCollectionViewModel>();
