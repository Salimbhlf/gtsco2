...
namespace gtsco2.mvvm.Views.EmployeurCollectionView{
    public partial class EmployeurCollectionView : XtraForm
    {
        public EmployeurCollectionView() {
            InitializeComponent();
			 if(!mvvmContext.IsDesignMode)
                InitBindings();
        }
        void InitBindings() {
            var fluentAPI = mvvmContext.OfType<gtsco2.mvvm.ViewModels.EmployeurCollectionViewModel>();
