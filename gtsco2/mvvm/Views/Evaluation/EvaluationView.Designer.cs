namespace gtsco2.mvvm.Views.EvaluationView {
    partial class EvaluationView {
		...
		private void InitializeComponent() {
			...
			this.dataLayoutControl1.DataSource = evaluationViewBindingSource;
			//
			//Create GridControls
			//
			...
			this.annee_scolaireLookUpEdit.DataBindings.Add("EditValue", evaluationViewBindingSource, "ID_Année_SCO", true, System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged);
			...
			this.Enseignant1LookUpEdit.DataBindings.Add("EditValue", evaluationViewBindingSource, "Enseignant", true, System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged);
			...
			this.ModuleLookUpEdit.DataBindings.Add("EditValue", evaluationViewBindingSource, "ID_Module", true, System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged);
			DevExpress.XtraDataLayout.RetrieveFieldParameters ModuleLookUpEditRetrieveFieldParameters = new DevExpress.XtraDataLayout.RetrieveFieldParameters();
            ModuleLookUpEditRetrieveFieldParameters.FieldName = "ID_Module";
            ModuleLookUpEditRetrieveFieldParameters.ControlForField = this.ModuleLookUpEdit;
			parameters.CustomListParameters.Add(ModuleLookUpEditRetrieveFieldParameters);
			DevExpress.XtraDataLayout.RetrieveFieldParameters ModuleLookUpEditRetrieveFieldParameters_NotGenerate = new DevExpress.XtraDataLayout.RetrieveFieldParameters();
		    ModuleLookUpEditRetrieveFieldParameters_NotGenerate.FieldName = "Module";
		    ModuleLookUpEditRetrieveFieldParameters_NotGenerate.GenerateField = false;
			parameters.CustomListParameters.Add(ModuleLookUpEditRetrieveFieldParameters_NotGenerate);
						//
			//SemestreLookUpEdit
			//
			...
			this.SemestreLookUpEdit.DataBindings.Add("EditValue", evaluationViewBindingSource, "ID_Semestre", true, System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged);
			...
			this.StagiairLookUpEdit.DataBindings.Add("EditValue", evaluationViewBindingSource, "Num_STG", true, System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged);
            ...
            this.mvvmContext.ViewModelType = typeof(gtsco2.mvvm.ViewModels.EvaluationViewModel);
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(gtsco2.mvvm.ViewModels.EvaluationViewModel), "Save", bbiSave));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(gtsco2.mvvm.ViewModels.EvaluationViewModel), "SaveAndClose", bbiSaveAndClose));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(gtsco2.mvvm.ViewModels.EvaluationViewModel), "SaveAndNew", bbiSaveAndNew));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(gtsco2.mvvm.ViewModels.EvaluationViewModel), "Reset", bbiReset));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(gtsco2.mvvm.ViewModels.EvaluationViewModel), "Delete", bbiDelete));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(gtsco2.mvvm.ViewModels.EvaluationViewModel), "Close", bbiClose));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(gtsco2.mvvm.ViewModels.EvaluationViewModel), "SaveLayout", bbiSaveLayout));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(gtsco2.mvvm.ViewModels.EvaluationViewModel), "ResetLayout", bbiResetLayout));
