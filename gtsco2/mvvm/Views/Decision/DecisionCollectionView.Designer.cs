namespace gtsco2.mvvm.Views.DecisionCollectionView {
    partial class DecisionCollectionView {
		...
		private void InitializeComponent() {
            ...
            this.ribbonPageGroup1.Text = "Decision Tasks";
			...
			this.gridControl.DataSource = decisionCollectionViewBindingSource;
			...
			//Promo
			//
			DevExpress.XtraGrid.Extensions.PopulateColumnParameters PromoPopulateColumnParameters = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            PromoPopulateColumnParameters.FieldName = "Promo";
            PromoPopulateColumnParameters.Path = "Promo.Code_Promo";
			parameters.CustomColumnParameters.Add(PromoPopulateColumnParameters);
						DevExpress.XtraGrid.Extensions.PopulateColumnParameters PromoPopulateColumnParameters_NotGenerate = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            PromoPopulateColumnParameters_NotGenerate.FieldName = "ID_Promo";
		    PromoPopulateColumnParameters_NotGenerate.ColumnVisible = false;
			parameters.CustomColumnParameters.Add(PromoPopulateColumnParameters_NotGenerate);
									//
			//Semestre
			//
			...
			DevExpress.XtraGrid.Extensions.PopulateColumnParameters PromoPopulateColumnParameters_NotVisible = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            PromoPopulateColumnParameters_NotVisible.FieldName = "Promo";
		    PromoPopulateColumnParameters_NotVisible.ColumnVisible = false;
			parameters.CustomColumnParameters.Add(PromoPopulateColumnParameters_NotVisible);
			...
			parameters.CustomColumnParameters.Add(StagiairPopulateColumnParameters_NotVisible);
						this.gridView.PopulateColumns(typeof(gtsco2.basededonne.Decision),parameters);
			// 
            // popupMenu1
            // 
            ...
            this.mvvmContext.ViewModelType = typeof(gtsco2.mvvm.ViewModels.DecisionCollectionViewModel);
								this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(gtsco2.mvvm.ViewModels.DecisionCollectionViewModel), "New", bbiNew));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(gtsco2.mvvm.ViewModels.DecisionCollectionViewModel), "Edit", "SelectedEntity", bbiEdit));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(gtsco2.mvvm.ViewModels.DecisionCollectionViewModel), "Delete", "SelectedEntity", bbiDelete));
					this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(gtsco2.mvvm.ViewModels.DecisionCollectionViewModel), "Refresh", bbiRefresh));
