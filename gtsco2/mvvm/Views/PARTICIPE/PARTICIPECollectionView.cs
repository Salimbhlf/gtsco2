...
namespace gtsco2.mvvm.Views.PARTICIPECollectionView{
    public partial class PARTICIPECollectionView : XtraForm
    {
        public PARTICIPECollectionView() {
            InitializeComponent();
			 if(!mvvmContext.IsDesignMode)
                InitBindings();
        }
        void InitBindings() {
            var fluentAPI = mvvmContext.OfType<gtsco2.mvvm.ViewModels.PARTICIPECollectionViewModel>();
