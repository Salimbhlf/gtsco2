namespace gtsco2.mvvm.Views.Contract_avenant_changementView {
    partial class Contract_avenant_changementView {
		...
		private void InitializeComponent() {
			...
			this.dataLayoutControl1.DataSource = contract_avenant_changementViewBindingSource;
			//
			//Create GridControls
			//
			...
			this.EmployeurLookUpEdit.DataBindings.Add("EditValue", contract_avenant_changementViewBindingSource, "id_emp", true, System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged);
			...
			this.StagiairLookUpEdit.DataBindings.Add("EditValue", contract_avenant_changementViewBindingSource, "num_stg", true, System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged);
            ...
            this.mvvmContext.ViewModelType = typeof(gtsco2.mvvm.ViewModels.Contract_avenant_changementViewModel);
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(gtsco2.mvvm.ViewModels.Contract_avenant_changementViewModel), "Save", bbiSave));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(gtsco2.mvvm.ViewModels.Contract_avenant_changementViewModel), "SaveAndClose", bbiSaveAndClose));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(gtsco2.mvvm.ViewModels.Contract_avenant_changementViewModel), "SaveAndNew", bbiSaveAndNew));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(gtsco2.mvvm.ViewModels.Contract_avenant_changementViewModel), "Reset", bbiReset));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(gtsco2.mvvm.ViewModels.Contract_avenant_changementViewModel), "Delete", bbiDelete));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(gtsco2.mvvm.ViewModels.Contract_avenant_changementViewModel), "Close", bbiClose));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(gtsco2.mvvm.ViewModels.Contract_avenant_changementViewModel), "SaveLayout", bbiSaveLayout));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(gtsco2.mvvm.ViewModels.Contract_avenant_changementViewModel), "ResetLayout", bbiResetLayout));
