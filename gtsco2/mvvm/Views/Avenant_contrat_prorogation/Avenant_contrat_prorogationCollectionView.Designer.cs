namespace gtsco2.mvvm.Views.Avenant_contrat_prorogationCollectionView {
    partial class Avenant_contrat_prorogationCollectionView {
		...
		private void InitializeComponent() {
            ...
            this.ribbonPageGroup1.Text = "Avenant_contrat_prorogation Tasks";
			...
			this.gridControl.DataSource = avenant_contrat_prorogationCollectionViewBindingSource;
			...
			parameters.CustomColumnParameters.Add(StagiairPopulateColumnParameters_NotVisible);
						this.gridView.PopulateColumns(typeof(gtsco2.basededonne.Avenant_contrat_prorogation),parameters);
			// 
            // popupMenu1
            // 
            ...
            this.mvvmContext.ViewModelType = typeof(gtsco2.mvvm.ViewModels.Avenant_contrat_prorogationCollectionViewModel);
								this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(gtsco2.mvvm.ViewModels.Avenant_contrat_prorogationCollectionViewModel), "New", bbiNew));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(gtsco2.mvvm.ViewModels.Avenant_contrat_prorogationCollectionViewModel), "Edit", "SelectedEntity", bbiEdit));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(gtsco2.mvvm.ViewModels.Avenant_contrat_prorogationCollectionViewModel), "Delete", "SelectedEntity", bbiDelete));
					this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(gtsco2.mvvm.ViewModels.Avenant_contrat_prorogationCollectionViewModel), "Refresh", bbiRefresh));
