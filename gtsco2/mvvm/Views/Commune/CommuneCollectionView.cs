...
namespace gtsco2.mvvm.Views.CommuneCollectionView{
    public partial class CommuneCollectionView : XtraForm
    {
        public CommuneCollectionView() {
            InitializeComponent();
			 if(!mvvmContext.IsDesignMode)
                InitBindings();
        }
        void InitBindings() {
            var fluentAPI = mvvmContext.OfType<gtsco2.mvvm.ViewModels.CommuneCollectionViewModel>();
