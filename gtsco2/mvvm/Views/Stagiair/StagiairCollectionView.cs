...
namespace gtsco2.mvvm.Views.StagiairCollectionView{
    public partial class StagiairCollectionView : XtraForm {
        public StagiairCollectionView() {
            InitializeComponent();
			 if(!mvvmContext.IsDesignMode)
                InitBindings();
        }
        void InitBindings() {
            var fluentAPI = mvvmContext.OfType<gtsco2.mvvm.ViewModels.StagiairCollectionViewModel>();
