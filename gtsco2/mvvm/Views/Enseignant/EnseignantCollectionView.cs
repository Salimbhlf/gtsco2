...
namespace gtsco2.mvvm.Views.EnseignantCollectionView{
    public partial class EnseignantCollectionView : XtraForm
    {
        public EnseignantCollectionView() {
            InitializeComponent();
			 if(!mvvmContext.IsDesignMode)
                InitBindings();
        }
        void InitBindings() {
            var fluentAPI = mvvmContext.OfType<gtsco2.mvvm.ViewModels.EnseignantCollectionViewModel>();
