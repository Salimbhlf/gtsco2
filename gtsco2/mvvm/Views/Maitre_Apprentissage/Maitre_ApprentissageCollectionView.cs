...
namespace gtsco2.mvvm.Views.Maitre_ApprentissageCollectionView{
    public partial class Maitre_ApprentissageCollectionView : XtraForm
    {
        public Maitre_ApprentissageCollectionView() {
            InitializeComponent();
			 if(!mvvmContext.IsDesignMode)
                InitBindings();
        }
        void InitBindings() {
            var fluentAPI = mvvmContext.OfType<gtsco2.mvvm.ViewModels.Maitre_ApprentissageCollectionViewModel>();
