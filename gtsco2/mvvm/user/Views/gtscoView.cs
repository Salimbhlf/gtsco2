...
namespace gtsco2.mvvm.user.Views.gtscoView{
    public partial class gtscoView : XtraUserControl {
        ...
        void InitializeNavigation() {
            ...
            var fluentAPI = mvvmContext.OfType<gtsco2.mvvm.user.ViewModels.gtscoViewModel>();
			            fluentAPI.BindCommand(navigationBarItemUserCollectionView, (x, m) => x.Show(m), x => x.Modules[0]);
			fluentAPI.BindCommand(barButtonItemUserCollectionView, (x, m) => x.Show(m), x => x.Modules[0]);
