namespace gtsco2.mvvm.Views.Suiver_stagiaireCollectionView {
    partial class Suiver_stagiaireCollectionView {
        /// <summary> 
		...
		private void InitializeComponent() {
            ...
            this.ribbonPageGroup1.Text = "Suiver_stagiaire Tasks";
			...
			this.suiver_stagiaireCollectionViewBindingSource.DataSource = typeof(gtsco2.basededonne.Suiver_stagiaire);
			this.gridControl.DataSource = suiver_stagiaireCollectionViewBindingSource;
			...
			//Semestre1
			//
			DevExpress.XtraGrid.Extensions.PopulateColumnParameters Semestre1PopulateColumnParameters = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            Semestre1PopulateColumnParameters.FieldName = "Semestre1";
            Semestre1PopulateColumnParameters.Path = "Semestre1.Designation_Semestre";
			parameters.CustomColumnParameters.Add(Semestre1PopulateColumnParameters);
						DevExpress.XtraGrid.Extensions.PopulateColumnParameters Semestre1PopulateColumnParameters_NotGenerate = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            Semestre1PopulateColumnParameters_NotGenerate.FieldName = "semestre";
		    Semestre1PopulateColumnParameters_NotGenerate.ColumnVisible = false;
			parameters.CustomColumnParameters.Add(Semestre1PopulateColumnParameters_NotGenerate);
									//
			//Stagiair
			//
			...
			DevExpress.XtraGrid.Extensions.PopulateColumnParameters Semestre1PopulateColumnParameters_NotVisible = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            Semestre1PopulateColumnParameters_NotVisible.FieldName = "Semestre1";
		    Semestre1PopulateColumnParameters_NotVisible.ColumnVisible = false;
			parameters.CustomColumnParameters.Add(Semestre1PopulateColumnParameters_NotVisible);
			...
			parameters.CustomColumnParameters.Add(StagiairPopulateColumnParameters_NotVisible);
						this.gridView.PopulateColumns(typeof(gtsco2.basededonne.Suiver_stagiaire),parameters);
			// 
            // popupMenu1
            // 
            ...
            this.mvvmContext.ViewModelType = typeof(gtsco2.mvvm.ViewModels.Suiver_stagiaireCollectionViewModel);
								this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(gtsco2.mvvm.ViewModels.Suiver_stagiaireCollectionViewModel), "New", bbiNew));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(gtsco2.mvvm.ViewModels.Suiver_stagiaireCollectionViewModel), "Edit", "SelectedEntity", bbiEdit));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(gtsco2.mvvm.ViewModels.Suiver_stagiaireCollectionViewModel), "Delete", "SelectedEntity", bbiDelete));
					this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(gtsco2.mvvm.ViewModels.Suiver_stagiaireCollectionViewModel), "Refresh", bbiRefresh));
			...
			//
			//Suiver_stagiaireCollectionView
			//
		...
		private System.Windows.Forms.BindingSource suiver_stagiaireCollectionViewBindingSource;
