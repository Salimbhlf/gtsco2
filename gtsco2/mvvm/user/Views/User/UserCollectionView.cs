...
namespace gtsco2.mvvm.user.Views.UserCollectionView{
    public partial class UserCollectionView : XtraForm {
        ...
        void InitBindings() {
            ...
            var fluentAPI = mvvmContext.OfType<gtsco2.mvvm.user.ViewModels.UserCollectionViewModel>();
            ...
            fluentAPI.WithEvent<GridView, FocusedRowObjectChangedEventArgs>(gridView, "FocusedRowObjectChanged")
                .SetBinding(x => x.SelectedEntity,
                    args => args.Row as gtsco2.basededonne.User,
