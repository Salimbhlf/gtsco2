...
namespace gtsco2.mvvm.Views.SpecialiteCollectionView{
    public partial class SpecialiteCollectionView : XtraForm
    {
        public SpecialiteCollectionView() {
            InitializeComponent();
			 if(!mvvmContext.IsDesignMode)
                InitBindings();
        }
        void InitBindings() {
            var fluentAPI = mvvmContext.OfType<gtsco2.mvvm.ViewModels.SpecialiteCollectionViewModel>();
