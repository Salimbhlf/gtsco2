...
namespace gtsco2.mvvm.Views.Contract_avenant_changementCollectionView{
    public partial class Contract_avenant_changementCollectionView : XtraForm
    {
        public Contract_avenant_changementCollectionView() {
            InitializeComponent();
			 if(!mvvmContext.IsDesignMode)
                InitBindings();
        }
        void InitBindings() {
            var fluentAPI = mvvmContext.OfType<gtsco2.mvvm.ViewModels.Contract_avenant_changementCollectionViewModel>();
