...
namespace gtsco2.mvvm.Views.OptionCollectionView{
    public partial class OptionCollectionView : XtraForm
    {
        public OptionCollectionView() {
            InitializeComponent();
			 if(!mvvmContext.IsDesignMode)
                InitBindings();
        }
        void InitBindings() {
            var fluentAPI = mvvmContext.OfType<gtsco2.mvvm.ViewModels.OptionCollectionViewModel>();
