...
namespace gtsco2.mvvm.Views.Suiver_stagiaireCollectionView{
    public partial class Suiver_stagiaireCollectionView : XtraForm
    {
        public Suiver_stagiaireCollectionView() {
            InitializeComponent();
			 if(!mvvmContext.IsDesignMode)
                InitBindings();
        }
        void InitBindings() {
            var fluentAPI = mvvmContext.OfType<gtsco2.mvvm.ViewModels.Suiver_stagiaireCollectionViewModel>();
