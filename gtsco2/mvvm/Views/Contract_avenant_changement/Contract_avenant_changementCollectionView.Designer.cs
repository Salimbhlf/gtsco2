namespace gtsco2.mvvm.Views.Contract_avenant_changementCollectionView {
    partial class Contract_avenant_changementCollectionView {
		...
		private void InitializeComponent() {
            ...
            this.ribbonPageGroup1.Text = "Contract_avenant_changement Tasks";
			...
			this.gridControl.DataSource = contract_avenant_changementCollectionViewBindingSource;
			...
			parameters.CustomColumnParameters.Add(StagiairPopulateColumnParameters_NotVisible);
						this.gridView.PopulateColumns(typeof(gtsco2.basededonne.Contract_avenant_changement),parameters);
			// 
            // popupMenu1
            // 
            ...
            this.mvvmContext.ViewModelType = typeof(gtsco2.mvvm.ViewModels.Contract_avenant_changementCollectionViewModel);
								this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(gtsco2.mvvm.ViewModels.Contract_avenant_changementCollectionViewModel), "New", bbiNew));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(gtsco2.mvvm.ViewModels.Contract_avenant_changementCollectionViewModel), "Edit", "SelectedEntity", bbiEdit));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(gtsco2.mvvm.ViewModels.Contract_avenant_changementCollectionViewModel), "Delete", "SelectedEntity", bbiDelete));
					this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(gtsco2.mvvm.ViewModels.Contract_avenant_changementCollectionViewModel), "Refresh", bbiRefresh));
