namespace gtsco2.mvvm.Views.ModuleCollectionView {
    partial class ModuleCollectionView {
        /// <summary> 
		...
		private void InitializeComponent() {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ModuleCollectionView));
            ...
            // gridControl
            // 
            this.gridControl.DataSource = this.moduleCollectionViewBindingSource;
            ...
            this.gridView});
            // 
            // moduleCollectionViewBindingSource
            // 
            this.moduleCollectionViewBindingSource.DataSource = typeof(gtsco2.basededonne.Module);
            // 
            // gridView
            // 
            ...
            this.ribbonPageGroup1.Text = "Gestion des Modules";
            // 
            // ribbonPageGroup2
            // 
            ...
            DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(gtsco2.mvvm.ViewModels.ModuleCollectionViewModel), "New", this.bbiNew),
            DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(gtsco2.mvvm.ViewModels.ModuleCollectionViewModel), "Edit", "SelectedEntity", this.bbiEdit),
            DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(gtsco2.mvvm.ViewModels.ModuleCollectionViewModel), "Delete", "SelectedEntity", this.bbiDelete),
            DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(gtsco2.mvvm.ViewModels.ModuleCollectionViewModel), "Refresh", this.bbiRefresh)});
            ...
            this.mvvmContext.ViewModelType = typeof(gtsco2.mvvm.ViewModels.ModuleCollectionViewModel);
            // 
            // popupMenu
            // 
            ...
            this.IconOptions.LargeImage = ((System.Drawing.Image)(resources.GetObject("ModuleCollectionView.IconOptions.LargeImage")));
            this.Name = "ModuleCollectionView";
            this.Text = "Module";
            ((System.ComponentModel.ISupportInitialize)(this.gridControl)).EndInit();
            ((System.ComponentModel.ISupportInitialize)(this.moduleCollectionViewBindingSource)).EndInit();
		...
		private System.Windows.Forms.BindingSource moduleCollectionViewBindingSource;
