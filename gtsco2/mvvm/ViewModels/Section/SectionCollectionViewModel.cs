...
namespace gtsco2.mvvm.ViewModels {
    ...
    /// </summary>
    public partial class SectionCollectionViewModel : CollectionViewModel<Section, int, IgtscoUnitOfWork> {

        /// <summary>
        /// Creates a new instance of SectionCollectionViewModel as a POCO view model.
        /// </summary>
        /// <param name="unitOfWorkFactory">A factory used to create a unit of work instance.</param>
        public static SectionCollectionViewModel Create(IUnitOfWorkFactory<IgtscoUnitOfWork> unitOfWorkFactory = null) {
        ...
        /// </summary>
        /// <param name="unitOfWorkFactory">A factory used to create a unit of work instance.</param>
        protected SectionCollectionViewModel(IUnitOfWorkFactory<IgtscoUnitOfWork> unitOfWorkFactory = null)
