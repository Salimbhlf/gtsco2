...
namespace gtsco2.mvvm.Views.EvaluationCollectionView{
    public partial class EvaluationCollectionView : XtraForm
    {
        public EvaluationCollectionView() {
            InitializeComponent();
			 if(!mvvmContext.IsDesignMode)
                InitBindings();
        }
        void InitBindings() {
            var fluentAPI = mvvmContext.OfType<gtsco2.mvvm.ViewModels.EvaluationCollectionViewModel>();
