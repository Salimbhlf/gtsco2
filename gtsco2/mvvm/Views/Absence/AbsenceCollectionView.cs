...
namespace gtsco2.mvvm.Views.AbsenceCollectionView{
    public partial class AbsenceCollectionView : XtraForm {
        public AbsenceCollectionView() {
            InitializeComponent();
			 if(!mvvmContext.IsDesignMode)
                InitBindings();
        }
        void InitBindings() {
            var fluentAPI = mvvmContext.OfType<gtsco2.mvvm.ViewModels.AbsenceCollectionViewModel>();
