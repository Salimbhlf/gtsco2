...
namespace gtsco2.mvvm.Views.Code_PostalCollectionView{
    public partial class Code_PostalCollectionView : XtraForm
    {
        public Code_PostalCollectionView() {
            InitializeComponent();
			 if(!mvvmContext.IsDesignMode)
                InitBindings();
        }
        void InitBindings() {
            var fluentAPI = mvvmContext.OfType<gtsco2.mvvm.ViewModels.Code_PostalCollectionViewModel>();
